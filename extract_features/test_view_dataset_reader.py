...
class MultiViewDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        views = []
        #print(orginal_views[0].split('/')[7]+'/'+orginal_views[0].split('/')[8]+'/'+orginal_views[0].split('/')[9]+'/'+orginal_views[0].split('/')[10])
        path = orginal_views[0].split('/')[7]+'/'+orginal_views[0].split('/')[8]+'/'+orginal_views[0].split('/')[9]+'/'+orginal_views[0].split('/')[10]
